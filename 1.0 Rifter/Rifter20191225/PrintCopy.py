...
def Printhtml(IQ,ME,MA,PS,PP,PE,PB,Speed,HP,SDC,MDC,attack,inish,dodge,strike,roll,skills,race,OCC,ISP,PPE,Psionic,damage,combat,equipment,weapon):
    ...
    print>>f, ("<h1> %s </h1>") % OCC
    if RND == "G":
        print>>f, ("<h3> Level %s </h3>") % stats.Level
    ...
    print>>f, ("<li> Dodge/Parry attack + %s </li>") % dodge
    ...
    if combat[0] == "HAND TO HAND: COMMANDO":
        print>>f, ("<li> Pull punch + %s </li>") % stats.pull
        print>>f, ("<li> Disarm + %s </li>") % stats.disarm
    print>>f, ("</div>")
    print>>f, ("<div style=\"float: left; width: 33%;>\"")
#this portion of code will only work on Keith's Computer
    if OCC == 'Pirate' or OCC == 'Privateer':
		path = "F:\PiratePics\\"
    ...
    for r in range (0,d):
        ...
        """
    title = (" Character printing selection")
    msg = ("Do you want to print the combat levels")
    cprint = easygui.ynbox(msg,title)
    print cprint
    if cprint == 1:
